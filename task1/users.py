...
@router.post('/users/', response_model=User, summary='Add new user')
...
@router.get('/users/', response_model=List[UserOut],  summary='Read users list')
...
@router.get('/users/{user_id}', response_model=UserOut, summary='Read one user by ID')
...
@router.put('/users/{user_id}', response_model=UserOut, summary='Edit user info')
